module Untied
  class ObserverHelper < Untied::Consumer::Observer
    ...
    def call_method(method, kind, payload)
      ...
      model_helper = Untied::ModelHelper.new(model_data)
      payload_proccessor = Untied::PayloadProccessor.new(model_data)
    ...
    def create_dep(payload, payload_proccessor)
      ...
      payload_proccessor.dependencies.each do |key, value|
        id = payload[value]
        aux_helper = Untied::ModelHelper.new(config[key.classify])
